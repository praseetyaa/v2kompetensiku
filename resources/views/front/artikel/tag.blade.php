...
@section('title', 'Tag: '.ucfirst($tag->tag).' | ')
...
<div class="container mt-3">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb bg-white p-3 shadow-sm rounded-1">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tag</a></li>
	    <li class="breadcrumb-item active" aria-current="page">{{ ucfirst($tag->tag) }}</a></li>
	  </ol>
	</nav>
</div>
<section>
